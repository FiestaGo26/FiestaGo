...
// Desconecta Google Calendar de un proveedor: para el watch, borra la conexión
// y elimina los bloqueos importados de Google (deja intactos los manuales).
export async function POST(req: NextRequest) {
  let providerId: string | undefined
  try {
    providerId = (await req.json())?.provider_id
  } catch {
